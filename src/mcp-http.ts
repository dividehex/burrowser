...
const TOOL_DESCRIPTIONS: Record<string, string> = {
  ...
  browser_navigate: 'Load a URL in the profile\'s browser and return the resulting page details. Each successful browser call keeps your lease alive.',
  browser_snapshot: 'Return a text snapshot of the page currently shown in the profile\'s browser.',
