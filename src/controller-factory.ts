...
export function createPostgresKubernetesController(repository: Pick<PostgresRepository, 'listControllerProfiles' | 'listControllerLeases'> & Partial<Pick<PostgresRepository, 'updateProfileState' | 'finalizeProfileDeletion'>>, kube: KubernetesPort, workerImage: string, intervalMs?: number) {
  return new ProfileController({
    state: {
      ...
      finalizeProfileDeletion: repository.finalizeProfileDeletion ? profileId => repository.finalizeProfileDeletion!(profileId) : undefined,
    },
